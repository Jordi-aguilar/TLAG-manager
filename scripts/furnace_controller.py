...
class DHS1100_controller:
    ...
    def change_power(self, target_power, duration = 10, gap = None):
        """
        ...
        while 1:
            if time.time() > (initial_time + approaching_time[index]):
                ...
                try:
                    self.dhs1100.write_target_power(approaching_power[index])
                except:
    ...
    def change_setpoint(self, setpoint, delta, ramp = 300):
        ...
        if not self.new_setpoint.is_set():
            self.dhs1100.write_setpoint(setpoint)
    ...
    def start_pid(self, setpoint, integral_term = None):
        ...
        while not self.new_pid.is_set():
            try:
                ...
                self.dhs1100.write_target_power(new_power)
                ...
                print("EXCEPTION HAS OCURRED IN PID LOOP OF DHS1100")
                self.new_pid.clear()
